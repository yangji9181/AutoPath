...
def parse_args():
	...
	parser.add_argument('--batch_size', type=int, default=2000, help='Number of trajectories sampled')
	...
	parser.add_argument('--classification_step', type=int, default=8, help='Number of rounds of mini batch SGD per epoch for classification')
	parser.add_argument('--PPO_step', type=int, default=20, help='Number of rounds of mini batch SGD per epoch for PPO')
